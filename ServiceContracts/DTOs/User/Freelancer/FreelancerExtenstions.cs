namespace ServiceContracts.DTOs.User.Freelancer
{
    ...
    {
        public static FreelancerReadDTO Freelancer_To_FreelancerRead(this Entities.User.User user)
        {
            if (user == null)
            {
                return null;
        ...
        public static Entities.User.User FreelancerCreate_To_User(this FreelancerCreateDTO createDto)
        {
            if (createDto == null)
            {
                return null;
        ...
        public static void FreelancerUpdate_To_Freelancer(this Entities.User.User user, FreelancerUpdateDTO updateDto)
        {
